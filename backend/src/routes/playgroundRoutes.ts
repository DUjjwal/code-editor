...
import { createPlayground, deletePlayground, duplicatePlayground, getAllPlayground, unmarkPlayground, markPlayground, editPlayground, getPlaygroundData } from "../controller/playgroundController.js";
...
router.route("/data").post(authMiddleware, getPlaygroundData)
